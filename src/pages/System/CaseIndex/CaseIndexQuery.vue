  ...
  <div class="mt-4 px-4">
    ...
    <div class="mb-4">
      ...
      <div class="input-group row g-0">
        <span class="col-sm-2 input-group-text py-2 px-4">代碼</span>
        <div class="col-sm-4 p-3 d-flex align-items-center">
          <Field class="form-control" type="text" />
        
        </div>
        <span class="col-sm-2 input-group-text py-2 px-4">名稱</span>
        <div class="col-sm-4 p-3 d-flex align-items-center">
          <Field class="form-control" type="text" />
        </div>
      </div>
      ...
      <div class="text-center mt-4">
        <button type="button" class="btn btn-primary btn-md w320" disabled>
          查詢
        </button>
      </div>
      ...
      <div class="text-end mt-4">
        <router-link
          to="/System/CaseIndex/Add"
          class="btn btn-secondary btn-sm fs-6"
        >
          <img
            src="@/assets/images/ic_white_add_circle.svg"
            title="新增"
          />新增索引
        </router-link>
      </div>
